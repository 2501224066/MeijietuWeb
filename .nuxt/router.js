...
const _105b02c4 = () => interopDefault(import('..\\pages\\user\\goodschange\\_goodsnum.vue' /* webpackChunkName: "pages_user_goodschange__goodsnum" */))
...
export function createRouter() {
  return new Router({
    ...
    routes: [{
      ...
      path: "/user/goodschange/:goodsnum?",
      component: _105b02c4,
      name: "user-goodschange-goodsnum"
    }, {
      path: "/goods/:goodsid?",
      component: _60f7c2ae,
      name: "goods-goodsid"
