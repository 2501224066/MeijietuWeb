<template>
    <div class="dingdanall">
        <div class="header_c color666"><span>当前位置:媒体主</span><span class="fr">客服编号:{{kefudata.user_num}}</span></div>
        <div class="dingdan_c">
...
export default {
    ...
    mounted() {
        ...
        this.$axios.post('/serveUserSelect',{user_num:'',phone:'',nickname:'',identity:'2'},{headers:{'Authorization':'Bearer'+localStorage.getItem('access_token')}})
        .then(res=>{
